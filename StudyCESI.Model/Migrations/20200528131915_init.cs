        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 15, 19, 15, 573, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 15, 19, 15, 578, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 15, 19, 15, 577, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 15, 19, 15, 576, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserExamAnswerId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Answer = table.Column<string>(nullable: true),
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 15, 19, 15, 579, DateTimeKind.Local)),
