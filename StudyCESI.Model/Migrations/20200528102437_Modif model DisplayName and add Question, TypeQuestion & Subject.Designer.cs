...
namespace StudyCESI.Model.Migrations
{
    ...
    [Migration("20200528102437_Modif model DisplayName and add Question, TypeQuestion & Subject")]
    partial class ModifmodelDisplayNameandaddQuestionTypeQuestionSubject
    {
            ...
            modelBuilder.Entity("StudyCESI.Model.Entities.BoolAnswer", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 28, 12, 24, 37, 747, DateTimeKind.Local));
            ...
            modelBuilder.Entity("StudyCESI.Model.Entities.ExamQuestion", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Date de création")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 12, 24, 37, 748, DateTimeKind.Local));
            ...
            modelBuilder.Entity("StudyCESI.Model.Entities.Subject", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Date de création")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 12, 24, 37, 744, DateTimeKind.Local));
            ...
            modelBuilder.Entity("StudyCESI.Model.Entities.UserExamAnswer", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Date de création")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 12, 24, 37, 749, DateTimeKind.Local));
