        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 19, 29, 15, 759, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 19, 29, 15, 768, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 19, 29, 15, 766, DateTimeKind.Local))
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exams", x => x.ExamId);
                    table.ForeignKey(
                        name: "FK_Exams_Subjects_Subject_SubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 19, 29, 15, 765, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Question_QuestionId = table.Column<int>(nullable: false),
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 19, 29, 15, 767, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Question_QuestionId = table.Column<int>(nullable: false),
                    CreationDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 5, 28, 19, 29, 15, 769, DateTimeKind.Local))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exams_Subject_SubjectId",
                table: "Exams",
